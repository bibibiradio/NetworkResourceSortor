...
/***/ function(module, exports, __webpack_require__) {
	...
	var Welcome = __webpack_require__(159);
	var User = __webpack_require__(160);

	main();

	function main() {
	   ReactDOM.render(React.createElement(User, {source: "/jsonTest.do"}), document.getElementById('example'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by saki on 16/1/2.
	 */

	var React = __webpack_require__(1);
	var WelcomeInfo = React.createClass({displayName: "WelcomeInfo",

	    render: function () {
	        return (
	            React.createElement("div", null, 
	                "Welcome, WebPack world!!!"
	            )
	        );
	    }
	});

	module.exports = WelcomeInfo;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by saki on 16/1/4.
	 */
	var React = __webpack_require__(1);
	var sendAjax = __webpack_require__(161);
	...
	var UserGist = React.createClass({displayName: "UserGist",
	    ...
	    render: function () {
	        return (
	            React.createElement("div", null, 
	                React.createElement("span", null, "Hi! ", this.state.username)
	            )
	        );
	    }
	});
	...
	var sendAjax = function (config) {
	    ...
	    function success(resp) {
	        ...
	        if (config.successCallback) {
	            infoObj = config.successCallback(resp);
	        }
	        if (!isOwnEmpty(infoObj)) {
	            alert(infoObj.msg);
	    ...
	    function error(resp) {
	        ...
	        if (config.errCallback) {
	            infoObj = config.errCallback(resp);
	        }
	        if (!isOwnEmpty(infoObj)) {
	            alert(infoObj.msg);
	        }
