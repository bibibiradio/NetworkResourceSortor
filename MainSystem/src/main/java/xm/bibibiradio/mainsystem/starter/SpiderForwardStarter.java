...
public class SpiderForwardStarter extends Thread {
    private ISpider spider;
    private String configPath;
    private Properties conf;
    private boolean isRun = false;
    private long lastStartTime;
    private static Logger logger = Logger.getLogger(SpiderForwardStarter.class);
    
    public SpiderForwardStarter(ISpider spider,String configPath){
        this.spider = spider;
    ...
    public void run(){
        try{
            ...
            if(spider != null){
                isRun = true;
                spider.startForward(configPath);
                lastStartTime = System.currentTimeMillis();
                isRun = false;
            }
        }catch(Exception ex){
